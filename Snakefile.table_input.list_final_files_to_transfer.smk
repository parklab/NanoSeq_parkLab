rule cram_convert_original_alignment_sample:
    ...
    output:
        ...
        original_alignment=FINAL_SAMPLE_CRAM+"{sample}.cram",
        original_alignment_index=FINAL_SAMPLE_CRAM+"{sample}.cram.crai",
...
rule cram_convert_original_alignment_control:
    ...
    output:
        ...
        original_alignment=FINAL_CONTROL_CRAM+"{control}.cram",
        original_alignment_index=FINAL_CONTROL_CRAM+"{control}.cram.crai",
