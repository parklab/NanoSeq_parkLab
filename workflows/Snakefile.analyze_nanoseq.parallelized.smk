...
rule indelCall_per_partition_w_ssIndel:
    input:
        ...
        argsJson                =   rules.start_indelCall.output.argsJson,
    output:
        indel_bed               =   indelPath_wJob+".indel.w_ssIndel.bed.gz",
        indel_vcf               =   indelPath_wJob+".indel.w_ssIndel.vcf.gz",
        indel_filtered_vcf      =   indelPath_wJob+".indel.w_ssIndel.filtered.vcf.gz",
        indel_filtered_vcf_tbi  =   indelPath_wJob+".indel.w_ssIndel.filtered.vcf.gz.tbi",
        doneFile                =   indelPath_wJob+".w_ssIndel.done",
    benchmark:
